...
impl kernel::Platform for CiaaNXP {
...
pub unsafe fn reset_handler() {
    ...
    let led = components::led::LedsComponent::new(
        components::led_component_helper!(
            lpc43xx::gpio::GPIOPin,
             (&lpc43xx::gpio::GPIO5[12],  kernel::hil::gpio::ActivationMode::ActiveHigh),
             (&lpc43xx::gpio::GPIO5[13],  kernel::hil::gpio::ActivationMode::ActiveHigh),
             (&lpc43xx::gpio::GPIO5[14],  kernel::hil::gpio::ActivationMode::ActiveHigh),
             (&lpc43xx::gpio::GPIO1[8], kernel::hil::gpio::ActivationMode::ActiveHigh)
            )
