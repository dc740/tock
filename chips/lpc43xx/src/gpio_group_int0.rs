...
#[repr(C)]
struct Gpio_Group_Int0Registers {
...
const GPIO_GROUP_INT0_BASE: StaticRef<Gpio_Group_Int0Registers> =
    unsafe { StaticRef::new(0x40088000 as *const Gpio_Group_Int0Registers) };
